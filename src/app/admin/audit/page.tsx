...
export default function AdminAuditPage() {
  ...
  const logs = useQuery(api.auditLogs.getAll, myInst?._id ? { institutionId: myInst._id as any } : "skip");
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-primary">Immutable Audit Trail</h1>
