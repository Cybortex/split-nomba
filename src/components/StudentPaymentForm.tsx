...
export function StudentPaymentForm() {
  ...
  if (!isSignedIn) {
    return (
      <div className="max-w-md mx-auto p-8 rounded-xl border border-border bg-surface text-center">
  ...
  return (
    <form onSubmit={handlePayment} className="max-w-md mx-auto p-8 rounded-xl border border-border bg-surface">
